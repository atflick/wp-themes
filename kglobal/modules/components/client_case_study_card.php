<?php // template for areas where we repeat same rectangular post preview ?>
  ...
  <a href="<?php the_permalink(); ?>" class="post-card case-study flex-100">
    <div class="flex-container inner-card">

    <?php // image view
    if(get_the_post_thumbnail_url()) { ?>

      <div class="image flex-50" style="background: url(<?php echo get_the_post_thumbnail_url(); ?>) center no-repeat; background-size: cover;">
      </div>
      <div class="post-info flex-container column flex-50">
