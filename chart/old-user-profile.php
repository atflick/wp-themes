...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    <div class="flex-container member-container gray-bg">
      <div class="flex-container profile-title"><h3>Edit Profile</h3>
      ...
      <div class="flex-col flex-3-4 padding-4 member-content">
            ...
            <?php else : ?>
                ...
                <form method="post" id="adduser" action="<?php the_permalink(); ?>">
                    <p class="flex-container column form-username">
                    ...
                    <p class="flex-container column form-email">
                        <label for="email"><?php _e('E-mail *', 'profile'); ?></label>
                        <input class="text-input" name="email" type="text" id="email" value="<?php the_author_meta( 'user_email', $current_user->ID ); ?>" />
                    </p><!-- .form-email -->
                    <p class="flex-container column form-url">
                        <label for="url"><?php _e('Website', 'profile'); ?></label>
                        <input class="text-input" name="url" type="text" id="url" value="<?php the_author_meta( 'user_url', $current_user->ID ); ?>" />
                    </p><!-- .form-url -->
                    <p class="flex-container column form-password">
                    ...
                    <p class="flex-container column form-textarea">
